...
fs() {
    echo "fs mode for: $@"
    sudo wondershaper clear wlo1 2>/dev/null
    "$@"
    echo "done! restoring..."
}
...
# Ollama local connection for Claude Code
...
export PATH="$PATH:/home/ario/.local/bin:$HOME/flutter/bin"

export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && source "$NVM_DIR/nvm.sh"

alias cb="colcon build --symlink-install"
alias cpy='tee /dev/tty | xclip -selection clipboard'
alias open='xdg-open'
