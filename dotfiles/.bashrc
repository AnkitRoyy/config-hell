...
# Created by `pipx` on 2026-01-25 16:29:32
export PATH="$PATH:/home/ario/.local/bin"
export PATH="$PATH:$HOME/flutter/bin"

# ---- FORCE MERCURY WORKSPACE ----
unset AMENT_PREFIX_PATH
unset COLCON_PREFIX_PATH
unset CMAKE_PREFIX_PATH

source /opt/ros/jazzy/setup.bash
source ~/Desktop/localization/mercury/install/setup.bash
